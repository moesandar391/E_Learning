        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="lg:col-span-2 space-y-4 text-center sm:text-left">
                ...
                <ul class="space-y-2.5 text-sm font-semibold text-[#566473] dark:text-slate-300">
                    ...
                    <li><a href="certificates.php" class="hover:text-brandOrange transition-colors duration-200">Certificates</a></li>
                </ul>
            </div>
            ...
            <div class="lg:col-span-3 space-y-4 text-center sm:text-left">
                ...
                <ul class="space-y-2.5 text-sm font-semibold text-[#566473] dark:text-slate-300">
                    ...
                    <li><a href="my_review.php" class="hover:text-brandOrange transition-colors duration-200">Write a Review</a></li>
                </ul>
            </div>
            ...
            <div class="lg:col-span-3 space-y-4 text-center sm:text-left">
                ...
                <ul class="space-y-2.5 text-sm font-semibold text-[#566473] dark:text-slate-300">
                    ...
                    <li><a href="contact.php" class="hover:text-brandOrange transition-colors duration-200">Report an Issue</a></li>
                </ul>
            </div>
