...
<aside id="sidebar"
    ...
    <div class="border-t border-gray-100 dark:border-gray-700 p-3 flex-shrink-0">
        <a href="../auth/logout.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-500 dark:text-gray-400 bg-red-100 dark:bg-red-900/30 hover:bg-red-200 dark:hover:bg-red-900/50 hover:text-red-600 transition-all duration-200 w-full justify-center">
