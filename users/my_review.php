...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-7xl mx-auto">
        ...
        <?php if (isset($_GET['write']) && $_GET['write'] == 1): ?>
                        ...
                        <div class="p-6">
                            ...
                            <div class="review-section">
                                <form method="POST" class="space-y-3">
                                    ...
                                    <div>
                                        <p class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Write a Review for <?php echo htmlspecialchars($enr['course_name']); ?> — <?php echo htmlspecialchars($enr['module_name']); ?></p>
                                    ...
                                    <div>
                                        <textarea name="review" rows="2" placeholder="Share your thoughts about this course..." required
                                            class="w-full border border-gray-200 rounded-xl p-3 text-sm text-gray-700 bg-gray-50 focus:outline-none focus:border-brandOrange focus:ring-2 focus:ring-brandOrange/20 transition-all resize-none"></textarea>
                                    </div>

                                    <div class="flex justify-end">
                                        <button type="submit" name="submit_review"
                                            class="px-5 py-2 bg-brandOrange text-white text-xs font-bold rounded-lg hover:bg-brandOrangeHover transition-colors">
                                            Submit Review
                                        </button>
                                    </div>
                                </form>
            ...
            <?php else: ?>
                <div class="bg-white rounded-2xl border border-gray-200 p-16 text-center shadow-sm mx-6">
                    <svg class="w-20 h-20 text-gray-200 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                    <p class="text-lg font-bold text-gray-500">No Completed Modules to Review</p>
                    <p class="text-sm text-gray-400 mt-2 max-w-sm mx-auto">Complete your enrolled courses first to leave a review.</p>
                    <a href="my_learning.php" class="mt-6 inline-block px-6 py-3 bg-brandOrange text-white text-sm font-bold rounded-xl hover:bg-brandOrangeHover transition-colors shadow-md">
                        Go to Dashboard
                    </a>
                </div>
            <?php endif; ?>
