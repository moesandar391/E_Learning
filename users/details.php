...
// Fetch related modules (same course, excluding current)
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2 space-y-10">
                    ...
                    <div class="relative h-72 bg-gradient-to-br from-orange-100 to-amber-50">
                        ...
                        <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center">
                                <svg class="w-24 h-24 text-orange-200" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
                            </div>
                        <?php endif; ?>
                ...
                <div class="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm">
                    ...
                    <?php else: ?>
                        <p class="text-gray-400">No specific requirements.</p>
                    <?php endif; ?>
                </div>
